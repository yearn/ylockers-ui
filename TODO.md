...
## Bugs
- [ ] (2026-01-02) yYB home APY uses yvyYB APR — expected: hero APY reflects yvyYB vault APR / actual: uses globalAverageApr — repro: open `/` in yYB app — spec: `docs/specs/yyb-home-apy-uses-yvyyb-apr.md`
- [ ] (2026-01-02) Clamp active/projected APR range length so the arrow stays visible when APRs exceed 100% — Earn panel (YbsDataBox) — spec: `docs/specs/clamp-active-apr-range-length.md`
