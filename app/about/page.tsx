      ...
      <section className="w-[1200px]">
        ...
        <div className="relative mx-auto mb-0 flex w-full flex-col bg-neutral-0">
          <div className="relative mx-auto mt-6 pb-40">
            ...
            <div className="col-span-3 mt-6 w-full items-center rounded-lg bg-darker-blue">
            ...
            <dl className="flex flex-col gap-4 p-4 md:p-6">
              ...
              <div className="flex w-full flex-col items-baseline justify-between opacity-40 md:flex-row">
