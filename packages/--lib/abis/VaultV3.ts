const abi = [
	...
	},
	{
		inputs: [{internalType: 'address', name: '_owner', type: 'address'}],
		name: 'maxMint',
		outputs: [{internalType: 'uint256', name: '_maxMint', type: 'uint256'}],
		stateMutability: 'view',
		type: 'function'
	},
	{
		inputs: [{internalType: 'address', name: '_owner', type: 'address'}],
		name: 'maxRedeem',
		outputs: [{internalType: 'uint256', name: '_maxRedeem', type: 'uint256'}],
		stateMutability: 'view',
		type: 'function'
	},
	{
		inputs: [{internalType: 'address', name: '_owner', type: 'address'}],
		name: 'maxWithdraw',
		outputs: [{internalType: 'uint256', name: '_maxWithdraw', type: 'uint256'}],
		stateMutability: 'view',
		type: 'function'
	},
	{
