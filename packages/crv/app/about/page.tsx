						...
						<div className="relative mx-auto mt-6 pb-40">
							<section className="grid-cols-12 gap-0 md:grid md:pt-12">
								<div className="col-span-12 md:col-span-6 md:mb-0 md:pr-20">
									...
									<div className="mb-8 border-white-200 py-2 text-white-700 md:border-l-4 border-deep-primary md:pl-6">
										<div>
											...
											<div className="mt-2 flex flex-col space-y-2 text-white font-thin white">
												<p>
													{
														"Each week, Yearn's veCRV position earns revenue from protocol fees and optimized vote incentives. This is converted to crvUSD stablecoin and distributed to yCRV stakers at the start of the week."
													}
												</p>
												<p>
													{
											...
											<h3 className="text-xl font-bold mt-6">And for the yCRV maxis…</h3>
											<div className="mt-2 flex flex-col space-y-2 text-white font-thin">
												<p>
													{
							...
							<div className="flex flex-col col-span-3 mt-6 rounded-lg bg-deeper-primary">
								<div className="mb-4 border-b p-4 md:p-6">
									<b className="text-2xl">yCRV deployment addresses</b>
								</div>
								<dl className="flex flex-col gap-2 p-4 md:p-6 ">
									<div className="flex flex-col justify-between md:flex-row">
										...
										<a
											...
											href="https://etherscan.io/address/0xE9A115b77A1057C918F997c32663FdcE24FB873f">
									...
									<div className="flex flex-col justify-between md:flex-row">
										...
										<a
											className="cursor-pointer text-xs hover:underline md:text-base"
											href="https://etherscan.io/address/0xB226c52EB411326CdB54824a88aBaFDAAfF16D3d">
									...
									<div className="flex flex-col justify-between md:flex-row">
										...
										<a
											className="cursor-pointer text-xs hover:underline md:text-base"
											href="https://etherscan.io/address/0x265c8D21A322B04804524b857089De2fEF619569">
									...
									<div className="flex flex-col justify-between md:flex-row">
										...
										<a
											className="cursor-pointer text-xs hover:underline md:text-base"
											href="https://etherscan.io/address/0x27B5739e22ad9033bcBf192059122d163b60349D">
									...
									<div className="flex flex-col justify-between md:flex-row">
										...
										<a
											className="cursor-pointer text-xs hover:underline md:text-base"
											href="https://etherscan.io/address/0xFCc5c47bE19d06BF83eB04298b026F81069ff65b">
